Shader "NatureManufacture/Lava River/Lava River Frozen"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			#endif
			float4 break29_g65 = _Base2TilingOffset;
			float2 appendResult24_g65 = (float2(break29_g65.x , break29_g65.y));
			float2 appendResult25_g65 = (float2(break29_g65.z , break29_g65.w));
			float2 uv_TexCoord26_g65 = i.uv_texcoord * appendResult24_g65 + appendResult25_g65;
			float3 break16_g65 = ase_worldPos;
			float2 appendResult17_g65 = (float2(break16_g65.x , break16_g65.z));
			#ifdef _Base2UsePlanarUV
				float2 staticSwitch3_g65 = ( appendResult17_g65 * ( 1.0 / break29_g65.x ) );
			#else
				float2 staticSwitch3_g65 = uv_TexCoord26_g65;
			#endif
			float4 break158 = SAMPLE_TEXTURE2D( _Base2MaskMap, sampler_Linear_Repeat, staticSwitch3_g65 );
			float clampResult347 = clamp( i.vertexColor.g , 0.0 , 1.0 );
			float temp_output_346_0 = ( ( staticSwitch342 * (( _HeightMin2 + _HeightOffset2 ) + (break158.b - 0.0) * (( _HeightMax2 + _HeightOffset2 ) - ( _HeightMin2 + _HeightOffset2 )) / (1.0 - 0.0)) ) * clampResult347 );
			...
			#endif
			float3 tex2DNode13_g66 = UnpackNormal( SAMPLE_TEXTURE2D( _Base2NormalMap, sampler_Linear_Repeat, staticSwitch3_g66 ) );
			float2 appendResult32_g66 = (float2(tex2DNode13_g66.r , tex2DNode13_g66.g));
			float2 appendResult39_g66 = (float2(sign( ase_worldNormal ).y , 1.0));
			float3 break41_g66 = ase_worldNormal;
			float2 appendResult42_g66 = (float2(break41_g66.x , break41_g66.z));
			float2 break44_g66 = ( ( appendResult32_g66 * appendResult39_g66 ) + appendResult42_g66 );
			float3 appendResult45_g66 = (float3(break44_g66.x , ( tex2DNode13_g66.b * break41_g66.y ) , break44_g66.y));
			float3 worldToTangentDir46_g66 = mul( ase_worldToTangent, appendResult45_g66);
			float3 normalizeResult48_g66 = normalize( worldToTangentDir46_g66 );
			#ifdef _Base2UsePlanarUV
				float3 staticSwitch31_g66 = normalizeResult48_g66;
			#else
				float3 staticSwitch31_g66 = tex2DNode13_g66;
			#endif
			float3 break31_g55 = staticSwitch31_g66;
			...
			float3 temp_output_325_98 = ( ( ( appendResult34_g54 * temp_output_119_0_g61 ) + ( temp_output_121_0_g61 * appendResult34_g55 ) ) / max( ( temp_output_119_0_g61 + temp_output_121_0_g61 ) , 1E-05 ) );
			o.Normal = temp_output_325_98;
			...
			float temp_output_107_0_g62 = temp_output_310_0;
			float temp_output_114_0_g62 = temp_output_346_0;
			float temp_output_116_0_g62 = ( max( temp_output_107_0_g62 , temp_output_114_0_g62 ) - _Height_Transition );
			float temp_output_119_0_g62 = max( ( temp_output_107_0_g62 - temp_output_116_0_g62 ) , 0.0 );
			float temp_output_121_0_g62 = max( ( temp_output_114_0_g62 - temp_output_116_0_g62 ) , 0.0 );
			float3 appendResult168 = (float3(_Base2Color.r , _Base2Color.g , _Base2Color.b));
			float4 break29_g63 = _Base2TilingOffset;
			float2 appendResult24_g63 = (float2(break29_g63.x , break29_g63.y));
			float2 appendResult25_g63 = (float2(break29_g63.z , break29_g63.w));
			float2 uv_TexCoord26_g63 = i.uv_texcoord * appendResult24_g63 + appendResult25_g63;
			float3 break16_g63 = ase_worldPos;
			float2 appendResult17_g63 = (float2(break16_g63.x , break16_g63.z));
			#ifdef _Base2UsePlanarUV
				float2 staticSwitch3_g63 = ( appendResult17_g63 * ( 1.0 / break29_g63.x ) );
			#else
				float2 staticSwitch3_g63 = uv_TexCoord26_g63;
			#endif
			float4 break157 = SAMPLE_TEXTURE2D( _Base2ColorMap, sampler_Linear_Repeat, staticSwitch3_g63 );
			...
			float4 temp_output_322_98 = ( ( ( appendResult114 * temp_output_119_0_g62 ) + ( temp_output_121_0_g62 * appendResult175 ) ) / max( ( temp_output_119_0_g62 + temp_output_121_0_g62 ) , 1E-05 ) );
			...
			float dotResult273 = dot( temp_output_325_98 , ase_tanViewDir );
