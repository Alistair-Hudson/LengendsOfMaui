...
{
    [CreateAssetMenu(fileName = "PlayerJumpAttack", menuName = "Player Attacks/Jump Attack", order = 0)]
    public class JumpAttack : ScriptableObject, IPlayerAttack
    {
        [SerializeField]
        ...
        {
            if (state is not JumpAttack attack)
            {
                return;
            }
