...
{
    [CreateAssetMenu(fileName = "PlayerBlockAttack", menuName = "Player Attacks/Block Attack", order = 0)]
    public class BlockAttack : ScriptableObject, IPlayerAttack
    {
        [SerializeField]
        ...
        {
            if (state is not BlockAttack attack)
            {
                return;
            }
